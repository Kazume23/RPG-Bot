...
abilities = {
    ...
    "chód": "**Chód**\nBohater porusza się cicho i zwinnie.\n+10 do testów Skradania się.",
    ...
    "mocny cios": "**Mocny cios**\nBohater potrafi uderzać z wielką siłą.\n+1 do obrażeń w walce wręcz.",
    "ożywieniec": "**Ożywieniec**\nBohater jest martwym stworzeniem, ale nadal funkcjonuje.\n[Efekt do uzupełnienia]",
    "poligłota": "**Poligłota**\nBohater zna wiele języków.\n+10 do testów Znajomości Języków.",
